...
class EventsControllerAdminException : public EventsControllerException {

    std::string message;
public:
    EventsControllerAdminException(const std::string &message);

};


class EventsControllerUserException : public EventsControllerException {

    std::string message;
public:
    EventsControllerUserException(const std::string &message);
